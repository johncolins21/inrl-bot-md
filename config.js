...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || '', //inrl~b9826sK3adf82b7fa72595d1d01db9eb6a48
    HEROKU: {
    ...
    BOT_INFO : process.env.BOT_INFO || "John Ai;INRL;https://i.imgur.com/WW3qVz8.jpg",
    ...
    STICKER_DATA : process.env.STICKER_DATA || "@colins",
    BRAINSHOP: process.env.BRAINSHOP || '172372,nbjE0YAlyw3cpoMl',
    SUDO : process.env.SUDO || "254746952667",
